...
class TestEngine(unittest.TestCase):
    def capulate_engine_needs_service(self,current_mileage,last_service_date, last_service_mileage):
    ...
    def sternman_engine_needs_service(self, last_service_date, warning_light_is_on):
    ...
    def willoughby_engine_needs_service(self, last_service_date, current_mileage, last_service_mileage):
...
class TestBattery(unittest.TestCase):
    def spindler_battery_needs_service(self,last_service_date):
        current_date = datetime.today().date()
        battery = SpindlerBattery(last_service_date, current_date)
        if(battery.battery_should_be_serviced()):
            self.assertTrue(True)
        else:
            self.assertTrue(False)

    def nubbin_battery_needs_service(self,last_service_date):
        current_date = datetime.today().date()
